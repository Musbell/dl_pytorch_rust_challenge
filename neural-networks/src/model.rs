...
/// Alias for a data loader over NdArray batches
pub type NdDataLoader = Arc<dyn DataLoader<NdArray, MnistBatch<NdArray>>>;
...
pub fn build_dataloaders(config: &MnistTrainingConfig) -> (NdDataLoader, NdDataLoader) {
